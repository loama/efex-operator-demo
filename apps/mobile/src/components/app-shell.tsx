...
const styles = StyleSheet.create({
  ...
  futureLabel: { color: "#B5B5B5", fontFamily: fonts.bodySemiBold, fontSize: 10, letterSpacing: 1.3 },
  futureItem: { color: "#A8A8A8", fontFamily: fonts.body, fontSize: 12 },
  ...
  mobileScroll: { gap: 18, paddingBottom: 128, paddingHorizontal: 16, paddingTop: 24 },
  ...
  bottomNav: { alignItems: "center", alignSelf: "center", backgroundColor: colors.paper, borderColor: colors.line, borderRadius: 18, borderWidth: 1, bottom: 26, flexDirection: "row", height: 68, justifyContent: "space-around", left: 14, paddingHorizontal: 5, position: "absolute", right: 14, shadowColor: "#000000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16 },
