...
const styles = StyleSheet.create({
  ...
  pill: { alignItems: "center", alignSelf: "flex-start", backgroundColor: colors.canvas, borderRadius: 999, height: 26, justifyContent: "center", paddingHorizontal: 9 },
  ...
  pillText: { color: colors.inkSoft, fontFamily: fonts.bodyMedium, fontSize: 11, includeFontPadding: false, lineHeight: 26, textAlignVertical: "center" },
